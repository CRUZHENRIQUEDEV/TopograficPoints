...
// Verificar se este script contém "Versão: 5.0"
const scriptContent = contentBeforeBody.substring(
  lastScriptStart,
  lastScriptEnd + 9,
);
if (!scriptContent.includes("Versão: 5.0")) {
  console.error('⚠️ Script encontrado mas não contém "Versão: 5.0"');
  console.log("Conteúdo do script:", scriptContent.substring(0, 100));

  // Verificar se já foi processado
  if (scriptContent.includes("main.obf.js")) {
    console.log(
      "✅ Parece que o arquivo já foi atualizado com o carregamento dinâmico!",
    );
    process.exit(0);
  }
  process.exit(1);
