...
window.requiredFields = {
  ...
  "altura-transicao": {
    ...
    required: function () {
      ...
      if (!encontroField) return false;
      const tipoEncontro = encontroField.value;
      return tipoEncontro !== "" && tipoEncontro !== "Nenhum";
    },
  },
  "cortina-altura": {
    type: "number",
  ...
  "altura-transicao": {
    ...
    required: function () {
      ...
      if (!tipoEncontroField) return false;
      const tipoEncontro = tipoEncontroField.value;
      // Se for "APOIO", altura transição é obrigatória
      if (tipoEncontro === "APOIO") return true;
      // Se for diferente de "Nenhum" e não vazio, também é obrigatório
      return tipoEncontro !== "" && tipoEncontro !== "Nenhum";
    },
  },
};
...
function validateForm() {
  ...
  if (!heightValid) {
    isValid = false;
    // A mensagem de erro específica é exibida no próprio campo através do validateMinimumHeight
    missingFields.push(
